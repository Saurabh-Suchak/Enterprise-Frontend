...
const assets = [
  { id: 1, name: "Dell XPS 15", type: "Laptop", status: "In Use", assignedTo: "John Doe", lastUpdated: "2023-11-01" },
  { id: 2, name: "iPhone 13", type: "Smartphone", status: "In Use", assignedTo: "Jane Smith", lastUpdated: "2023-10-15" },
  { id: 3, name: "HP ProLiant DL380", type: "Server", status: "Maintenance", assignedTo: "IT Department", lastUpdated: "2023-11-05" },
  { id: 4, name: "Lenovo ThinkPad X1", type: "Laptop", status: "Available", assignedTo: "-", lastUpdated: "2023-11-02" },
  { id: 5, name: "Samsung Galaxy S21", type: "Smartphone", status: "In Use", assignedTo: "Mike Johnson", lastUpdated: "2023-10-20" },
]
...
export default function ITAssetDashboard() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">IT Asset Management Dashboard</h1>
